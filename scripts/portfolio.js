...
/* ===== Project Data ===== */
const PROJECTS = [
    { title: "Gucci",  role: "Dirección de Arte & Desarrollo",  desc: "Una exploración de diseño integral que desafía los límites de la narrativa visual a través de interacciones cuidadosamente elaboradas.", img2:"./img/gucci/gucci-1", img3:"./img/gucci/gucci-2.jpg" },
    { title: "Activia",   role: "Desarrollo Creativo",           desc: "Una plataforma digital inmersiva que fusiona tecnología y visión artística para crear experiencias de usuario memorables.", img2:"./img/activia/activia-1.jpg", img3:"./img/activia/activia-2.jpg" },
    { title: "Saeco", role: "Diseño & Desarrollo",          desc: "Desarrollo creativo full-stack para una experiencia web de nueva generación con interacciones personalizadas.", img2:"./img/saeco/saeco-1.jpg", img3:"./img/saeco/saeco-2.jpg" },
    { title: "Rituals",  role: "Diseño UI/UX",                 desc: "Sistema de diseño mobile-first creado con precisión y atención a las micro-interacciones." , img2:"./img/rituals/rituals-1.jpg", img3:"./img/rituals/rituals-2.jpg"},
];
...
function updateGallery() {
    ...
    cards.forEach((card, i) => {
        ...
        img.style.transform = `translateX(${norm * -0.2 * CARD_W}px)`;
